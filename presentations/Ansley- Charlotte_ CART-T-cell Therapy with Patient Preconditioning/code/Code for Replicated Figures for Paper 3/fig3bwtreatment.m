% replicate figure3b treatment
% 3 days of chemo + 4 days rest + cart injection on day8
% chemo: high strength for one half hour each day for 3 days (C3), 125
% cart: 2.5e8 at day 7
clc;clear all;close all;

%figure name to save and cart dose
figname = "fig3bnotreat.jpg";
...
t4 = tspan(index3+1:index4);%days from 4 to 7
T0 = T(end);
E0 = E(end);
CT0 = CT(end);
M0 = M(end);
